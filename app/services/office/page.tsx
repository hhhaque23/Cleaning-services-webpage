...
export const metadata: Metadata = {
  ...
  description:
    "Commercial and office cleaning across Wayne & Washtenaw County. Recurring or one-time, custom-quoted for your space. Email us for a quote.",
};
          ...
          <div className="grid lg:grid-cols-[1.15fr_1fr] gap-10 lg:gap-14 items-center">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lead text-ink-700 leading-relaxed text-pretty">
                ...
                spaces across Wayne &amp; Washtenaw County. Every space is priced for its size and

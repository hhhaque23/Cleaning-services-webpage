...
export const ALL_PHOTOS: { src: string; thumb: string; label: string; sub: string }[] = [
  { src: hero(ID.livingArchVaultGrey),   thumb: thumb(ID.livingArchVaultGrey),   label: "Living room", sub: "Standard · Canton" },
  ...
  { src: hero(ID.officeOpenPlan),        thumb: thumb(ID.officeOpenPlan),        label: "Office",      sub: "Recurring · Canton" },
  ...
  { src: hero(ID.diningTraditional),     thumb: thumb(ID.diningTraditional),     label: "Dining room", sub: "Deep · Canton" },
  ...
  { src: hero(ID.officeConferenceWood),  thumb: thumb(ID.officeConferenceWood),  label: "Office",      sub: "Recurring · Canton" },
  { src: hero(ID.livingWoodPanelFloral), thumb: thumb(ID.livingWoodPanelFloral), label: "Great room",  sub: "Deep · Chelsea" },
  { src: hero(ID.entryStaircase),        thumb: thumb(ID.entryStaircase),        label: "Entryway",    sub: "Move-out · Canton" },
  ...
  { src: hero(ID.laundryWhite),          thumb: thumb(ID.laundryWhite),          label: "Laundry room", sub: "Move-out · Canton" },
  { src: hero(ID.libraryDen),            thumb: thumb(ID.libraryDen),            label: "Home library", sub: "Standard · Canton" },
  { src: hero(ID.livingWhiteStone),      thumb: thumb(ID.livingWhiteStone),      label: "Living room", sub: "Weekly · Canton" },
